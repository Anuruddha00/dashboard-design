            ...
            <div className='dashboard'>
                <div className='dashboardSideBar'>
                   <div className='dashboardSideBarAction'>
                        <button className='dashboardSideBarActionButtonDashboard' dataIsActive='true'><span><DashboardIcon/></span> Dashboard</button>
                        <button className='dashboardSideBarActionButton' dataIsActive='flase'><span><DvrIcon/></span> All Courses</button>
                        <button className='dashboardSideBarActionButton' dataIsActive='flase'><span><LocalAtmIcon/></span> Investment</button>
                        <button className='dashboardSideBarActionButton' dataIsActive='flase'><span><BorderColorIcon/></span> Blog</button>     
                    </div>
