            ...
            <div className='dashboard'>
                <div className='dashboardSideBar'>
                   <div className='dashboardSideBarTitle'>
                        ...
                        <h3 className='dashboardSideBarTitleOthers'>All Courses</h3>
                        <h3 className='dashboardSideBarTitleOthers'>Investment</h3>
                        <h3 className='dashboardSideBarTitleOthers'>Blog</h3>
                   </div>
                   <p>Contact Us</p>
                </div>
