            ...
            <div className='dashboard'>
                <div className='dashboardSideBar'>
                   <div className='dashboardSideBarAction'>
                        ...
                        <button className='dashboardSideBarActionCourses' dataIsActive='flase'><span><DvrIcon/></span> All Courses</button>
                        <button className='dashboardSideBarActionInvestment' dataIsActive='flase'><span><LocalAtmIcon/></span> Investment</button>
                        <button className='dashboardSideBarActionBlog' dataIsActive='flase'><span><BorderColorIcon/></span> Blog</button>     
                    </div>
